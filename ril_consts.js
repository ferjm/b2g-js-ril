...
SMS_ERROR_UNASSIGNED_NUMBER = 1;
SMS_ERROR_OPERATOR_DETERMINED_BARRING = 8;
SMS_ERROR_CALL_BARRED = 10;
SMS_ERROR_SHORT_MESSAGE_TRANSFER_REJ = 21;
SMS_ERROR_DESTINATION_OUT_OF_SERVICE = 27;
SMS_ERROR_UNINDENTIFIED_SUSCRIBER = 28;
SMS_ERROR_FACILITY_REJECTED = 29;
SMS_ERROR_UNKNOWN_SUSCRIBER = 30;
SMS_ERROR_NETWORK_OUT_OF_ORDER = 38;
SMS_ERROR_TEMPORARY_FAILURE = 41;
SMS_ERROR_CONGESTION = 42;
SMS_ERROR_RESOURCES_UNAVAILABLE = 47;
SMS_ERROR_REQUESTED_FACILITY_NOT_SUBSCRIBED = 50;
SMS_ERROR_REQUESTED_FACILITY_NOT_IMPLEMENTED = 69;
SMS_ERROR_INVALID_SHORT_MESSAGE_TRANSFER_REF_VALUE = 81;
SMS_ERROR_INVALID_MESSAGE_UNSPECIFIED = 95;
SMS_ERROR_INVALID_MANDATORY_INFORMATION = 96;
SMS_ERROR_MESSAGE_TYPE_NON_EXISTENT_OR_NOT_IMPLEMENTED = 97;
SMS_ERROR_MESSAGE_NOT_COMPATIBLE_WITH_SHORT_MESSAGE_PROTOCOL_STATE = 98;
SMS_ERROR_INFORMATION_ELEMENT_NON_EXISTENT_OR_NOT_IMPLEMENTED = 99;
SMS_ERROR_PROTOCOL_ERROR_UNSPECIFIED = 111;
SMS_ERROR_INTERWORKING_UNSPECIFIED = 127;
SMS_ERROR_TELEMATIC_INTERWORKING_NOT_SUPPORTED = 128;
SMS_ERROR_SHORT_MESSAGE_TYPE_0_NOT_SUPPORTED = 129;
SMS_ERROR_UNSPECIFIED_TP_DCS_ERROR = 143;
SMS_ERROR_DATA_CODING_SCHEME_NOT_SUPPORTED = 144;
SMS_ERROR_MESSAGE_CLASS_NOT_SUPPORTED = 145;
SMS_ERROR_UNSPECIFIED_TP_DCS_ERROR = 159;
SMS_ERROR_COMMAND_CANNOT_BE_ACTIONED = 160;
SMS_ERROR_COMMAND_UNSUPPORTED = 161;
SMS_ERROR_UNSPECIFIED_TP_COMMAND_ERROR = 175;
SMS_ERROR_TPDU_NOT_SUPPORTED = 176;
SMS_ERROR_SC_BUSY = 192;
SMS_ERROR_NO_SC_SUBSCRIPTION = 193;
SMS_ERROR_SC_SYSTEM_FAILURE = 194;
SMS_ERROR_INVALID_SME_ADDRESS = 195;
SMS_ERROR_DESTINATION_SME_BARRED = 196;
SMS_ERROR_REJECTED_DUPLICATE_SM = 197;
SMS_ERROR_SIM_SMS_STORAGE_FULL = 208;
SMS_ERROR_NO_SMS_STORAGE_CAPABILITY_IN_SIM = 209;
SMS_ERROR_ERROR_IN_MS = 210;
SMS_ERROR_MEMORY_CAPACITY_EXCEEDED = 211;
SMS_ERROR_UNSPECIFIED_ERROR_CAUSE = 255;
SMS_ERROR_ME_FAILURE = 300;
SMS_ERROR_SMS_SERVICE_OF_ME_RESERVED = 301;
SMS_ERROR_OPERATION_NOT_ALLOWED = 302;
SMS_ERROR_OPERATION_NOT_SUPPORTED = 303;
SMS_ERROR_INVALID_PDU_MODE_PARAMETER = 304;
SMS_ERROR_INVALID_TEXT_MODE_PARAMETER = 305;
SMS_ERROR_U_SIM_NOT_INSERTED = 310;
SMS_ERROR_U_SIM_PIN_REQUIRED = 311;
SMS_ERROR_PH_U_SIM_PIN_REQUIRED = 312;
SMS_ERROR_U_SIM_FAILURE = 313;
SMS_ERROR_U_SIM_BUSY = 314;
SMS_ERROR_U_SIM_WRONG = 315;
SMS_ERROR_U_SIM_PUK_REQUIRED = 316;
SMS_ERROR_U_SIM_PIN2_REQUIRED = 317;
SMS_ERROR_U_SIM_PUK2_REQUIRED = 318;
SMS_ERROR_MEMORY_FAILURE = 320;
SMS_ERROR_INVALID_MEMORY_INDEX = 321;
SMS_ERROR_MEMORY_FULL = 322;
SMS_ERROR_SMSC_ADDRESS_UNKNOWN = 330;
SMS_ERROR_NO_NETWORK_SERVICE = 331;
SMS_ERROR_NETWORK_TIMEOUT = 332;
SMS_ERROR_NO_CNMA_ACKNOWLEDGEMENT_EXP = 340;
SMS_ERROR_UNKOWN_ERROR = 500;
